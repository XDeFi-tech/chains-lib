...
export class MsgClientImpl implements Msg {
  ...
  mint(request: MsgMint): Promise<MsgMintResponse> {
    ...
    return promise.then((data) =>
      MsgMintResponse.decode(new BinaryReader(data))
    );
  }
  burn(request: MsgBurn): Promise<MsgBurnResponse> {
    ...
    return promise.then((data) =>
      MsgBurnResponse.decode(new BinaryReader(data))
    );
  }
  changeAdmin(request: MsgChangeAdmin): Promise<MsgChangeAdminResponse> {
    ...
    return promise.then((data) =>
      MsgChangeAdminResponse.decode(new BinaryReader(data))
    );
  }
  setDenomMetadata(
    request: MsgSetDenomMetadata
  ...
  setBeforeSendHook(
    ...
    return promise.then((data) =>
      MsgSetBeforeSendHookResponse.decode(new BinaryReader(data))
    );
  }
  forceTransfer(request: MsgForceTransfer): Promise<MsgForceTransferResponse> {
    ...
    return promise.then((data) =>
      MsgForceTransferResponse.decode(new BinaryReader(data))
    );
  }
}
