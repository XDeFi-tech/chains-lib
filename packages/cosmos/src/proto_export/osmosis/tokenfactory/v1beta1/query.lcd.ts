...
import {
  ...
  QueryBeforeSendHookAddressResponseSDKType,
  QueryAllBeforeSendHooksAddressesRequest,
  QueryAllBeforeSendHooksAddressesResponseSDKType,
} from './query';
export class LCDQueryClient {
  ...
  ): Promise<QueryDenomAuthorityMetadataResponseSDKType> {
    const endpoint = `osmosis/tokenfactory/v1beta1/denoms/${params.denom}/authority_metadata`;
    return await this.req.get<QueryDenomAuthorityMetadataResponseSDKType>(
      endpoint
    );
  }
  ...
  ): Promise<QueryDenomsFromCreatorResponseSDKType> {
  ...
  async beforeSendHookAddress(
    params: QueryBeforeSendHookAddressRequest
  ): Promise<QueryBeforeSendHookAddressResponseSDKType> {
    const endpoint = `osmosis/tokenfactory/v1beta1/denoms/${params.denom}/before_send_hook`;
    return await this.req.get<QueryBeforeSendHookAddressResponseSDKType>(
      endpoint
    );
  }
  /* AllBeforeSendHooksAddresses defines a gRPC query method for
   ...
   hook addresse's idx. */
  async allBeforeSendHooksAddresses(
    _params: QueryAllBeforeSendHooksAddressesRequest = {}
  ): Promise<QueryAllBeforeSendHooksAddressesResponseSDKType> {
    const endpoint = `osmosis/tokenfactory/v1beta1/all_before_send_hooks`;
    return await this.req.get<QueryAllBeforeSendHooksAddressesResponseSDKType>(
      endpoint
    );
  }
}
