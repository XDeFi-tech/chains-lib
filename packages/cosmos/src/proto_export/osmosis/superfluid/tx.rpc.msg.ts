...
export interface Msg {
  ...
  ): Promise<MsgUnPoolWhitelistedPoolResponse>;
  ...
  ): Promise<MsgUnbondConvertAndStakeResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  superfluidDelegate(
    ...
    return promise.then((data) =>
      MsgSuperfluidDelegateResponse.decode(new BinaryReader(data))
    );
  }
  superfluidUndelegate(
    request: MsgSuperfluidUndelegate
    ...
    return promise.then((data) =>
      MsgSuperfluidUndelegateResponse.decode(new BinaryReader(data))
    );
  }
  superfluidUnbondLock(
    request: MsgSuperfluidUnbondLock
    ...
    return promise.then((data) =>
      MsgSuperfluidUnbondLockResponse.decode(new BinaryReader(data))
    );
  }
  superfluidUndelegateAndUnbondLock(
    request: MsgSuperfluidUndelegateAndUnbondLock
    ...
    return promise.then((data) =>
      MsgSuperfluidUndelegateAndUnbondLockResponse.decode(
  ...
  lockAndSuperfluidDelegate(
    ...
    return promise.then((data) =>
      MsgLockAndSuperfluidDelegateResponse.decode(new BinaryReader(data))
    );
  }
  createFullRangePositionAndSuperfluidDelegate(
    request: MsgCreateFullRangePositionAndSuperfluidDelegate
    ...
    const data =
      MsgCreateFullRangePositionAndSuperfluidDelegate.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.superfluid.Msg',
      'CreateFullRangePositionAndSuperfluidDelegate',
      data
  ...
  unPoolWhitelistedPool(
    ...
    return promise.then((data) =>
      MsgUnPoolWhitelistedPoolResponse.decode(new BinaryReader(data))
    );
  }
  unlockAndMigrateSharesToFullRangeConcentratedPosition(
    request: MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition
  ...
  addToConcentratedLiquiditySuperfluidPosition(
    ...
    const data =
      MsgAddToConcentratedLiquiditySuperfluidPosition.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.superfluid.Msg',
      'AddToConcentratedLiquiditySuperfluidPosition',
      data
  ...
  unbondConvertAndStake(
    ...
    return promise.then((data) =>
      MsgUnbondConvertAndStakeResponse.decode(new BinaryReader(data))
    );
  }
}
