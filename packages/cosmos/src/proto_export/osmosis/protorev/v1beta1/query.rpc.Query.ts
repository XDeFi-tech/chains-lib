...
export interface Query {
  ...
  ): Promise<QueryGetProtoRevEnabledResponse>;
  /**
  ...
  ): Promise<QueryGetProtoRevPoolResponse>;
  /**
...
export class QueryClientImpl implements Query {
  ...
  getProtoRevNumberOfTrades(
    ...
    return promise.then((data) =>
      QueryGetProtoRevNumberOfTradesResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevProfitsByDenom(
    request: QueryGetProtoRevProfitsByDenomRequest
    ...
    return promise.then((data) =>
      QueryGetProtoRevProfitsByDenomResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevAllProfits(
    request: QueryGetProtoRevAllProfitsRequest = {}
    ...
    return promise.then((data) =>
      QueryGetProtoRevAllProfitsResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevStatisticsByRoute(
    request: QueryGetProtoRevStatisticsByRouteRequest
    ...
    const data =
      QueryGetProtoRevStatisticsByRouteRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevStatisticsByRoute',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevStatisticsByRouteResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevAllRouteStatistics(
    request: QueryGetProtoRevAllRouteStatisticsRequest = {}
    ...
    const data =
      QueryGetProtoRevAllRouteStatisticsRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevAllRouteStatistics',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevAllRouteStatisticsResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevTokenPairArbRoutes(
    request: QueryGetProtoRevTokenPairArbRoutesRequest = {}
    ...
    const data =
      QueryGetProtoRevTokenPairArbRoutesRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevTokenPairArbRoutes',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevTokenPairArbRoutesResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevAdminAccount(
    request: QueryGetProtoRevAdminAccountRequest = {}
    ...
    return promise.then((data) =>
      QueryGetProtoRevAdminAccountResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevDeveloperAccount(
    request: QueryGetProtoRevDeveloperAccountRequest = {}
    ...
    const data =
      QueryGetProtoRevDeveloperAccountRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevDeveloperAccount',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevDeveloperAccountResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevInfoByPoolType(
    request: QueryGetProtoRevInfoByPoolTypeRequest = {}
    ...
    return promise.then((data) =>
      QueryGetProtoRevInfoByPoolTypeResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevMaxPoolPointsPerTx(
    request: QueryGetProtoRevMaxPoolPointsPerTxRequest = {}
    ...
    const data =
      QueryGetProtoRevMaxPoolPointsPerTxRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevMaxPoolPointsPerTx',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevMaxPoolPointsPerTxResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevMaxPoolPointsPerBlock(
    request: QueryGetProtoRevMaxPoolPointsPerBlockRequest = {}
    ...
    const data =
      QueryGetProtoRevMaxPoolPointsPerBlockRequest.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.protorev.v1beta1.Query',
      'GetProtoRevMaxPoolPointsPerBlock',
      data
    ...
    return promise.then((data) =>
      QueryGetProtoRevMaxPoolPointsPerBlockResponse.decode(
  ...
  getProtoRevBaseDenoms(
    ...
    return promise.then((data) =>
      QueryGetProtoRevBaseDenomsResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevEnabled(
    request: QueryGetProtoRevEnabledRequest = {}
    ...
    return promise.then((data) =>
      QueryGetProtoRevEnabledResponse.decode(new BinaryReader(data))
    );
  }
  getProtoRevPool(
    request: QueryGetProtoRevPoolRequest
    ...
    return promise.then((data) =>
      QueryGetProtoRevPoolResponse.decode(new BinaryReader(data))
    );
  }
  getAllProtocolRevenue(
    request: QueryGetAllProtocolRevenueRequest = {}
    ...
    return promise.then((data) =>
      QueryGetAllProtocolRevenueResponse.decode(new BinaryReader(data))
    );
  }
}
...
export interface UseGetProtoRevNumberOfTradesQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevNumberOfTradesResponse, TData> {
  request?: QueryGetProtoRevNumberOfTradesRequest;
}
export interface UseGetProtoRevProfitsByDenomQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevProfitsByDenomResponse, TData> {
  request: QueryGetProtoRevProfitsByDenomRequest;
}
export interface UseGetProtoRevAllProfitsQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevAllProfitsResponse, TData> {
  request?: QueryGetProtoRevAllProfitsRequest;
}
export interface UseGetProtoRevStatisticsByRouteQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevStatisticsByRouteResponse, TData> {
  request: QueryGetProtoRevStatisticsByRouteRequest;
}
export interface UseGetProtoRevAllRouteStatisticsQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevAllRouteStatisticsResponse, TData> {
  request?: QueryGetProtoRevAllRouteStatisticsRequest;
}
export interface UseGetProtoRevTokenPairArbRoutesQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevTokenPairArbRoutesResponse, TData> {
  request?: QueryGetProtoRevTokenPairArbRoutesRequest;
}
export interface UseGetProtoRevAdminAccountQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevAdminAccountResponse, TData> {
  request?: QueryGetProtoRevAdminAccountRequest;
}
export interface UseGetProtoRevDeveloperAccountQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevDeveloperAccountResponse, TData> {
  request?: QueryGetProtoRevDeveloperAccountRequest;
}
export interface UseGetProtoRevInfoByPoolTypeQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevInfoByPoolTypeResponse, TData> {
  request?: QueryGetProtoRevInfoByPoolTypeRequest;
}
export interface UseGetProtoRevMaxPoolPointsPerTxQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevMaxPoolPointsPerTxResponse, TData> {
  request?: QueryGetProtoRevMaxPoolPointsPerTxRequest;
}
export interface UseGetProtoRevMaxPoolPointsPerBlockQuery<TData>
...
export interface UseGetProtoRevBaseDenomsQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevBaseDenomsResponse, TData> {
  request?: QueryGetProtoRevBaseDenomsRequest;
}
export interface UseGetProtoRevEnabledQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevEnabledResponse, TData> {
  request?: QueryGetProtoRevEnabledRequest;
}
export interface UseGetProtoRevPoolQuery<TData>
  extends ReactQueryParams<QueryGetProtoRevPoolResponse, TData> {
  request: QueryGetProtoRevPoolRequest;
}
export interface UseGetAllProtocolRevenueQuery<TData>
  extends ReactQueryParams<QueryGetAllProtocolRevenueResponse, TData> {
  request?: QueryGetAllProtocolRevenueRequest;
}
...
export const createRpcQueryHooks = (rpc: ProtobufRpcClient | undefined) => {
  ...
  const useGetProtoRevNumberOfTrades = <
    TData = QueryGetProtoRevNumberOfTradesResponse
  >({
    request,
    options,
  }: UseGetProtoRevNumberOfTradesQuery<TData>) => {
    return useQuery<QueryGetProtoRevNumberOfTradesResponse, Error, TData>(
      ['getProtoRevNumberOfTradesQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevNumberOfTrades(request);
      },
  ...
  const useGetProtoRevProfitsByDenom = <
    TData = QueryGetProtoRevProfitsByDenomResponse
  >({
    request,
    options,
  }: UseGetProtoRevProfitsByDenomQuery<TData>) => {
    return useQuery<QueryGetProtoRevProfitsByDenomResponse, Error, TData>(
      ['getProtoRevProfitsByDenomQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevProfitsByDenom(request);
      },
  ...
  const useGetProtoRevAllProfits = <
    TData = QueryGetProtoRevAllProfitsResponse
  >({
    request,
    options,
  }: UseGetProtoRevAllProfitsQuery<TData>) => {
    return useQuery<QueryGetProtoRevAllProfitsResponse, Error, TData>(
      ['getProtoRevAllProfitsQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevAllProfits(request);
      },
  ...
  const useGetProtoRevStatisticsByRoute = <
    TData = QueryGetProtoRevStatisticsByRouteResponse
  >({
    request,
    options,
  }: UseGetProtoRevStatisticsByRouteQuery<TData>) => {
    return useQuery<QueryGetProtoRevStatisticsByRouteResponse, Error, TData>(
      ['getProtoRevStatisticsByRouteQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevStatisticsByRoute(request);
      },
  ...
  const useGetProtoRevAllRouteStatistics = <
    TData = QueryGetProtoRevAllRouteStatisticsResponse
  >({
    request,
    options,
  }: UseGetProtoRevAllRouteStatisticsQuery<TData>) => {
    return useQuery<QueryGetProtoRevAllRouteStatisticsResponse, Error, TData>(
      ['getProtoRevAllRouteStatisticsQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevAllRouteStatistics(request);
      },
  ...
  const useGetProtoRevTokenPairArbRoutes = <
    TData = QueryGetProtoRevTokenPairArbRoutesResponse
  >({
    request,
    options,
  }: UseGetProtoRevTokenPairArbRoutesQuery<TData>) => {
    return useQuery<QueryGetProtoRevTokenPairArbRoutesResponse, Error, TData>(
      ['getProtoRevTokenPairArbRoutesQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevTokenPairArbRoutes(request);
      },
  ...
  const useGetProtoRevAdminAccount = <
    TData = QueryGetProtoRevAdminAccountResponse
  >({
    request,
    options,
  }: UseGetProtoRevAdminAccountQuery<TData>) => {
    return useQuery<QueryGetProtoRevAdminAccountResponse, Error, TData>(
      ['getProtoRevAdminAccountQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevAdminAccount(request);
      },
  ...
  const useGetProtoRevDeveloperAccount = <
  ...
  >({
    ...
    return useQuery<QueryGetProtoRevDeveloperAccountResponse, Error, TData>(
      ['getProtoRevDeveloperAccountQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevDeveloperAccount(request);
      },
  ...
  const useGetProtoRevInfoByPoolType = <
    TData = QueryGetProtoRevInfoByPoolTypeResponse
  >({
    request,
    options,
  }: UseGetProtoRevInfoByPoolTypeQuery<TData>) => {
    return useQuery<QueryGetProtoRevInfoByPoolTypeResponse, Error, TData>(
      ['getProtoRevInfoByPoolTypeQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevInfoByPoolType(request);
      },
  ...
  const useGetProtoRevMaxPoolPointsPerTx = <
    TData = QueryGetProtoRevMaxPoolPointsPerTxResponse
  >({
    request,
    options,
  }: UseGetProtoRevMaxPoolPointsPerTxQuery<TData>) => {
    return useQuery<QueryGetProtoRevMaxPoolPointsPerTxResponse, Error, TData>(
      ['getProtoRevMaxPoolPointsPerTxQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevMaxPoolPointsPerTx(request);
      },
  ...
  const useGetProtoRevMaxPoolPointsPerBlock = <
    TData = QueryGetProtoRevMaxPoolPointsPerBlockResponse
  >({
    request,
    options,
    ...
    return useQuery<
      ...
      TData
    >(
      ['getProtoRevMaxPoolPointsPerBlockQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevMaxPoolPointsPerBlock(request);
      },
  ...
  const useGetProtoRevBaseDenoms = <
    TData = QueryGetProtoRevBaseDenomsResponse
  >({
    request,
    options,
  }: UseGetProtoRevBaseDenomsQuery<TData>) => {
    return useQuery<QueryGetProtoRevBaseDenomsResponse, Error, TData>(
      ['getProtoRevBaseDenomsQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevBaseDenoms(request);
      },
  ...
  const useGetProtoRevEnabled = <TData = QueryGetProtoRevEnabledResponse>({
    ...
    return useQuery<QueryGetProtoRevEnabledResponse, Error, TData>(
      ['getProtoRevEnabledQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevEnabled(request);
      },
  ...
  const useGetProtoRevPool = <TData = QueryGetProtoRevPoolResponse>({
    ...
    return useQuery<QueryGetProtoRevPoolResponse, Error, TData>(
      ['getProtoRevPoolQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getProtoRevPool(request);
      },
  ...
  const useGetAllProtocolRevenue = <
    TData = QueryGetAllProtocolRevenueResponse
  >({
    request,
    options,
  }: UseGetAllProtocolRevenueQuery<TData>) => {
    return useQuery<QueryGetAllProtocolRevenueResponse, Error, TData>(
      ['getAllProtocolRevenueQuery', request],
      () => {
        if (!queryService) throw new Error('Query Service not initialized');
        return queryService.getAllProtocolRevenue(request);
      },
