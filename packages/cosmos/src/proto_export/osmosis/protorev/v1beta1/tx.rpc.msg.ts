...
export interface Msg {
  ...
  ): Promise<MsgSetDeveloperAccountResponse>;
  /**
  ...
  ): Promise<MsgSetMaxPoolPointsPerTxResponse>;
  /**
  ...
  ): Promise<MsgSetInfoByPoolTypeResponse>;
  /**
...
export class MsgClientImpl implements Msg {
  ...
  setHotRoutes(request: MsgSetHotRoutes): Promise<MsgSetHotRoutesResponse> {
    ...
    return promise.then((data) =>
      MsgSetHotRoutesResponse.decode(new BinaryReader(data))
    );
  }
  setDeveloperAccount(
    request: MsgSetDeveloperAccount
    ...
    return promise.then((data) =>
      MsgSetDeveloperAccountResponse.decode(new BinaryReader(data))
    );
  }
  setMaxPoolPointsPerTx(
    request: MsgSetMaxPoolPointsPerTx
    ...
    return promise.then((data) =>
      MsgSetMaxPoolPointsPerTxResponse.decode(new BinaryReader(data))
    );
  }
  setMaxPoolPointsPerBlock(
    request: MsgSetMaxPoolPointsPerBlock
    ...
    return promise.then((data) =>
      MsgSetMaxPoolPointsPerBlockResponse.decode(new BinaryReader(data))
    );
  }
  setInfoByPoolType(
    request: MsgSetInfoByPoolType
    ...
    return promise.then((data) =>
      MsgSetInfoByPoolTypeResponse.decode(new BinaryReader(data))
    );
  }
  setBaseDenoms(request: MsgSetBaseDenoms): Promise<MsgSetBaseDenomsResponse> {
    ...
    return promise.then((data) =>
      MsgSetBaseDenomsResponse.decode(new BinaryReader(data))
    );
  }
}
