...
export interface Msg {
  ...
  ): Promise<MsgDelegateToValidatorSetResponse>;
  /**
  ...
  ): Promise<MsgRedelegateValidatorSetResponse>;
  /**
  ...
  ): Promise<MsgDelegateBondedTokensResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  setValidatorSetPreference(
    ...
    return promise.then((data) =>
      MsgSetValidatorSetPreferenceResponse.decode(new BinaryReader(data))
    );
  }
  delegateToValidatorSet(
    request: MsgDelegateToValidatorSet
    ...
    return promise.then((data) =>
      MsgDelegateToValidatorSetResponse.decode(new BinaryReader(data))
    );
  }
  undelegateFromValidatorSet(
    request: MsgUndelegateFromValidatorSet
    ...
    return promise.then((data) =>
      MsgUndelegateFromValidatorSetResponse.decode(new BinaryReader(data))
    );
  }
  undelegateFromRebalancedValidatorSet(
    request: MsgUndelegateFromRebalancedValidatorSet
    ...
    const data =
      MsgUndelegateFromRebalancedValidatorSet.encode(request).finish();
    const promise = this.rpc.request(
      'osmosis.valsetpref.v1beta1.Msg',
      'UndelegateFromRebalancedValidatorSet',
      data
    ...
    return promise.then((data) =>
      MsgUndelegateFromRebalancedValidatorSetResponse.decode(
  ...
  redelegateValidatorSet(
    ...
    return promise.then((data) =>
      MsgRedelegateValidatorSetResponse.decode(new BinaryReader(data))
    );
  }
  withdrawDelegationRewards(
    request: MsgWithdrawDelegationRewards
    ...
    return promise.then((data) =>
      MsgWithdrawDelegationRewardsResponse.decode(new BinaryReader(data))
    );
  }
  delegateBondedTokens(
    request: MsgDelegateBondedTokens
    ...
    return promise.then((data) =>
      MsgDelegateBondedTokensResponse.decode(new BinaryReader(data))
    );
  }
}
