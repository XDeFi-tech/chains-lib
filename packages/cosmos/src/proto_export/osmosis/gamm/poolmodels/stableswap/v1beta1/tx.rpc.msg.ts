...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.stableSwapAdjustScalingFactors =
      this.stableSwapAdjustScalingFactors.bind(this);
  }
  createStableswapPool(
    request: MsgCreateStableswapPool
  ): Promise<MsgCreateStableswapPoolResponse> {
    ...
    return promise.then((data) =>
      MsgCreateStableswapPoolResponse.decode(new BinaryReader(data))
    );
  }
  stableSwapAdjustScalingFactors(
    request: MsgStableSwapAdjustScalingFactors
    ...
    return promise.then((data) =>
      MsgStableSwapAdjustScalingFactorsResponse.decode(new BinaryReader(data))
    );
  }
}
