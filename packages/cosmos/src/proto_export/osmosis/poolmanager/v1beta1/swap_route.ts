...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SwapAmountInRoute.aminoType,
  SwapAmountInRoute.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SwapAmountOutRoute.aminoType,
  SwapAmountOutRoute.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SwapAmountInSplitRoute.aminoType,
  SwapAmountInSplitRoute.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SwapAmountOutSplitRoute.aminoType,
  SwapAmountOutSplitRoute.typeUrl
);
