...
export interface Msg {
  ...
  ): Promise<MsgSetDenomPairTakerFeeResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  splitRouteSwapExactAmountIn(
    ...
    return promise.then((data) =>
      MsgSplitRouteSwapExactAmountInResponse.decode(new BinaryReader(data))
    );
  }
  splitRouteSwapExactAmountOut(
    request: MsgSplitRouteSwapExactAmountOut
    ...
    return promise.then((data) =>
      MsgSplitRouteSwapExactAmountOutResponse.decode(new BinaryReader(data))
    );
  }
  setDenomPairTakerFee(
    request: MsgSetDenomPairTakerFee
    ...
    return promise.then((data) =>
      MsgSetDenomPairTakerFeeResponse.decode(new BinaryReader(data))
    );
  }
}
