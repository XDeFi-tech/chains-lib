...
export const MsgSetFeeTokens = {
  ...
  is(o: any): o is MsgSetFeeTokens {
    return (
      o &&
      (o.$typeUrl === MsgSetFeeTokens.typeUrl ||
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgSetFeeTokens.aminoType,
  MsgSetFeeTokens.typeUrl
);
...
export const MsgSetFeeTokensResponse = {
  ...
  fromProtoMsg(
    message: MsgSetFeeTokensResponseProtoMsg
  ): MsgSetFeeTokensResponse {
  ...
  toProtoMsg(
    message: MsgSetFeeTokensResponse
  ): MsgSetFeeTokensResponseProtoMsg {
    return {
      typeUrl: '/osmosis.txfees.v1beta1.MsgSetFeeTokensResponse',
...
GlobalDecoderRegistry.register(
  MsgSetFeeTokensResponse.typeUrl,
  MsgSetFeeTokensResponse
);
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgSetFeeTokensResponse.aminoType,
  MsgSetFeeTokensResponse.typeUrl
);
