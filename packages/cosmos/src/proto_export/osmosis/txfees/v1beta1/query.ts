...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryFeeTokensRequest.aminoType,
  QueryFeeTokensRequest.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryFeeTokensResponse.aminoType,
  QueryFeeTokensResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryDenomSpotPriceRequest.aminoType,
  QueryDenomSpotPriceRequest.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryDenomSpotPriceResponse.aminoType,
  QueryDenomSpotPriceResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryDenomPoolIdRequest.aminoType,
  QueryDenomPoolIdRequest.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryDenomPoolIdResponse.aminoType,
  QueryDenomPoolIdResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryBaseDenomRequest.aminoType,
  QueryBaseDenomRequest.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryBaseDenomResponse.aminoType,
  QueryBaseDenomResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryEipBaseFeeRequest.aminoType,
  QueryEipBaseFeeRequest.typeUrl
);
...
export const QueryEipBaseFeeResponse = {
  ...
  toAminoMsg(
    message: QueryEipBaseFeeResponse
  ): QueryEipBaseFeeResponseAminoMsg {
    return {
      type: 'osmosis/txfees/query-eip-base-fee-response',
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryEipBaseFeeResponse.aminoType,
  QueryEipBaseFeeResponse.typeUrl
);
