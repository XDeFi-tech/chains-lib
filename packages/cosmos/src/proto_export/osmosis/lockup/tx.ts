...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgLockTokensResponse.aminoType,
  MsgLockTokensResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgBeginUnlockingAllResponse.aminoType,
  MsgBeginUnlockingAllResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgBeginUnlockingResponse.aminoType,
  MsgBeginUnlockingResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgExtendLockupResponse.aminoType,
  MsgExtendLockupResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgForceUnlockResponse.aminoType,
  MsgForceUnlockResponse.typeUrl
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  MsgSetRewardReceiverAddressResponse.aminoType,
  MsgSetRewardReceiverAddressResponse.typeUrl
);
