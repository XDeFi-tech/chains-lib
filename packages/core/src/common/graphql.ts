...
export type GetCryptoAssetsQuery = {
  ...
  assets: {
    ...
    cryptoAssets?: Array<{
      ...
      price?: { __typename?: 'AssetAmountType'; amount: string; scalingFactor: number } | null;
    }> | null;
  };
};
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: 'NonNullType',
                type: { kind: 'NamedType', name: { kind: 'Name', value: 'CryptoAssetArgs' } },
              },
            },
          },
        },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'decimals' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            { kind: 'Field', name: { kind: 'Name', value: 'scalingFactor' } },
                          ],
                        },
                      },
                    ],
