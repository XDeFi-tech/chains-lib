...
import { CHAIN_SCOPE_NAME, Decorator } from './chain.decorator';
...
describe('chain.decorator', () => {
  ...
  it('should have metadata name', () => {
    const decorator = Decorator('MyName');
    const MyChain = class {};
  ...
  it('should save options in metadata', () => {
    ...
    const decorator = Decorator('MyName', options);
    const MyChain = class {};
  ...
  it('should init class based dependencies', () => {
    ...
    const decorator = Decorator('MyChain', options);
    const MyChain = class {};
