...
export type CosmosBasedChainDailyBalancesArgs = {
  address: Scalars['String'];
  dateRange?: OptDateRange;
};
...
export type JunoChainDailyBalancesArgs = {
  address: Scalars['String'];
  dateRange?: OptDateRange;
};
...
export type StargazeChainDailyBalancesArgs = {
  address: Scalars['String'];
  dateRange?: OptDateRange;
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'slotRange' },
          },
          type: {
            kind: 'NonNullType',
            type: {
