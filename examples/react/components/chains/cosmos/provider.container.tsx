...
const CosmosProviderContainer = (props: IProviderContainer) => {
  ...
  new CosmosProvider.dataSourceList.IndexerDataSource(COSMOS_MANIFESTS.${provider.manifest.chain})
);
...
export default CosmosProviderContainer;
