...
const TransferComponent = (props: ITransferComponent) => {
  ...
  const [denom, setDenom] = React.useState<string>('bnb');
  ...
  return (
    <Box sx={{ marginTop: '1em' }}>
      ...
      >
        {`import { BinanceProvider, BINANCE_MANIFEST } from '@xdefi-tech/chains-binance';
import { SeedPhraseSigner } from '@xdefi-tech/chains-binance/dist/signers/web';
