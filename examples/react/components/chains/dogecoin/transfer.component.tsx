...
const TransferComponent = (props: ITransferComponent) => {
  ...
  return (
    <Box sx={{ marginTop: '1em' }}>
      ...
      >
        {`import { DogecoinProvider, DOGECOIN_MANIFEST } from '@xdefi-tech/chains-dogecoin';
import { SeedPhraseSigner } from '@xdefi-tech/chains-dogecoin/dist/signers/web';

const provider = new DogecoinProvider(
