...
const EvmProviderContainer = (props: IProviderContainer) => {
  ...
  new EvmProvider.dataSourceList.IndexerDataSource(EVM_MANIFESTS.${provider.manifest.chain})
);
...
export default EvmProviderContainer;
