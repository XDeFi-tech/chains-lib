...
const ThorProviderContainer = (props: IProviderContainer) => {
  ...
  new ThorProvider.dataSourceList.IndexerDataSource(THORCHAIN_MANIFESTS.${provider.manifest.chain})
);
...
export default ThorProviderContainer;
