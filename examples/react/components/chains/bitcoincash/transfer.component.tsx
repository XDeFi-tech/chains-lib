...
const TransferComponent = (props: ITransferComponent) => {
  ...
  }, [fromAddress, toAddress, amount, decimals]);
  ...
  return (
    <Box sx={{ marginTop: '1em' }}>
      ...
      >
        {`import { BitcoinCashProvider, BITCOINCASH_MANIFEST } from '@xdefi-tech/chains-bitcoincash';
import { SeedPhraseSigner } from '@xdefi-tech/chains-bitcoincash/dist/signers/web';

const provider = new BitcoinCashProvider(
  new BitcoinCashProvider.dataSourceList.IndexerDataSource(BITCOINCASH_MANIFEST)
);
